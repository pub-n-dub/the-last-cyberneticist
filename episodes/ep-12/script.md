...
It is not a straight history episode.
...
We have a known historical orbit around Edmund C. Berkeley.

We have a small group of named engineers around `Simon` and `Squee`.

We have one named `Squee` assistant whose recollections are very important.
...
And that point matters a great deal.

Because the moment a machine looks as though it was meant to be watched, we are no longer dealing only with function.

We are dealing with presentation.
...
Not because Jacques Tati had anything to do with building it.

He did not, as far as I know.

I call it that because the machine feels cinematic.

It feels as though it belongs to a world in which machinery is expressive.

It feels like a machine that carries its own choreography.
...
We know that `Simon` was not built by Berkeley alone.

That matters.

A lot of these histories like to compress everything down to one name.
...
`Robert A. Jensen`, an electrical-engineering student who helped engineer the machine into working order.
...
That is a competence bundle.

And that competence bundle matters because when I look at the Tati robot, I see exactly the kind of machine that would require such a bundle.

Not one genius.

Not one lecturer.

Not one hobbyist with a box of parts.
...
And `Squee` gives us the next important clue.

Because `Squee` is smaller, earlier, and less sophisticated than the Tati robot.
...
He did not say all the work happened in a formal Berkeley lab.

He said he took the robot home.

He worked on it in his apartment in the Bronx.

He went to Berkeley's office about once a week.

Most of the parts already existed.

But the machine did not run reliably.
...
It tells us assistants could exercise substantial practical control over how a machine finally behaved.

It tells us the published official line may not capture the whole machine culture around it.

And once you know that, the Tati robot starts to look less impossible.
...
I checked whether there was any evidence that `Jensen`, `Vall`, or `Porter` had family ties in France that might explain how such a machine wound up in Paris.
...
The France-family theory is weak.

The engineering-culture theory is strong.
...
`Jack Koff` plus one or more of the Simon people.

This is also strong.

Why?

Because Koff is explicitly tied to taking a half-working robot and making it actually work.

He sits in the exact zone between concept and behavior.
...
This is, in some ways, my strongest explanation overall.
...
But awareness is not the same thing as authorship.

And authorship is not the same thing as publication.

I find it easier to believe that Berkeley knew something was being built, or knew of a side-current of machine work, than to believe he knew absolutely nothing.
...
The Tati robot feels like it may have come from slightly different hands.

Hands still in Berkeley's world.

But perhaps more seduced by the machine as a presence.

More seduced by what the machine looked like while behaving.
...
Evidence that the published history may be thinner than the workshop history.

Evidence that named figures often stand on top of unnamed or under-described technical cultures.
...
Eventually we have to build.

Eventually we have to test whether that apparent coherence is real.
...
What kind of behavioral transitions.
...
I do not think the Tati robot was the work of a lone genius.

I do not think the France clue is, by itself, very strong.

I do think the machine most likely came out of a collaborative builder culture.

And if I had to name the strongest suspects, I would name `Porter`, `Jensen`, and `Vall`, with `Jack Koff` as the strongest bridge figure from the `Squee` side.
